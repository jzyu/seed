...
/**
 * Desction:RecyclerView添加Header/Footer适配器
 * Author:pengjianbo
 * Date:16/3/4 下午3:43
 */
public class HeaderAndFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final String TAG = HeaderAndFooterRecyclerViewAdapter.class.getSimpleName();
    ...
    public boolean removeHeader(View v) {
        if (mHeaderViews.contains(v)) {
            ...
            int position = mHeaderViews.indexOf(v);
    ...
    public long getItemId(int position) {
        ...
        if (null != mFooterViews && position >= headersCount) {
            ...
            if (adjustPosition < adapterCount) {
                return mInnerAdapter.getItemId(adjustPosition);
            }
        }
        return -1;
    }
    ...
    public int getItemViewType(int position) {
        ...
        if (null != mInnerAdapter) {
            ...
            if (position < mHeadersCount) {
                ...
                int itemViewType = mInnerAdapter.getItemViewType(position - mHeadersCount);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (null != mInnerAdapter) {
            if (position >= getHeadersCount() && position < getHeadersCount() + mInnerAdapter.getItemCount()) {
                mInnerAdapter.onBindViewHolder(holder, position - getHeadersCount());
                if(null != mOnItemClickListener){
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            mOnItemClickListener.onItemClick(holder, holder.getAdapterPosition() - getHeadersCount());
                        }
                    });
                }
                if (null != mOnItemLongClickListener){
                    holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            return mOnItemLongClickListener.onItemLongCLick(holder, holder.getAdapterPosition() - getHeadersCount());
                        }
                    });
                }
            } else {
                ...
                }/* else if (null != mLayoutManager && mLayoutManager instanceof GridLayoutManager){
    ...
    private RecyclerView.AdapterDataObserver mDataObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onChanged() {
            super.onChanged();
            //Log.v(HeaderAndFooterRecyclerViewAdapter.TAG + "-" + TAG, "onChanged");
        ...
        public void onItemRangeChanged(int positionStart, int itemCount) {
            ...
            //Log.v(HeaderAndFooterRecyclerViewAdapter.TAG + "-" + TAG, "onItemRangeChanged");
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            ...
            //Log.v(HeaderAndFooterRecyclerViewAdapter.TAG + "-" + TAG, "onItemRangeInserted");
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            ...
            //Log.v(HeaderAndFooterRecyclerViewAdapter.TAG + "-" + TAG, "onItemRangeRemoved");
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            //Log.v(HeaderAndFooterRecyclerViewAdapter.TAG + "-" + TAG, "onItemRangeMoved");
